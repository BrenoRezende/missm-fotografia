...
namespace Service
{
    public class GerenciadorCliente
    {
        ...
        public GerenciadorCliente()
        {
         ...
         /// <summary>
        /// Construtor acessado apenas dentro do componente service e permite compartilhar
        ...
        {
            IEnumerable<ClienteModel> cliente = GetQuery().Where(clienteModel => clienteModel.IdCliente.Equals(idCliente));

            return cliente.ElementAtOrDefault(0);
        }
        ...
        /// <returns>ClienteServicoModel</returns>
        ...
        /// <summary>
        /// Atribui dados de ClienteModel para a Cliente Entity
        /// </summary>
        ...
        private void Atribuir(ClienteModel clienteModel, tb_pessoa clienteE)
        {
            ...
            clienteE.tipoPessoa = clienteModel.Tipo;
        }
